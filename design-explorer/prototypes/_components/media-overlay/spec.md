...
Status: **Shared Prototype Component — Draft / Provisional** (not an approved Design System component). First used by: Batch 1 (Home Promotion Popup, Launch Promotion Interstitial).

- **Popup variant:** a full-width square (1:1) artwork panel, vertically centered in an `overlay` (Reference 440 × 439, square corners, no close control). medium / expanded: centered, max 480 (Draft tablet presentation).
